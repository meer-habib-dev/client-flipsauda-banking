...
import { Container, LogoImg, Title, Text, ContainerHeader, ContainerForm, AlignButtons, TextBlule } from './styles';
import LogoFlip from '../../../../assets/logo_flip_cor.png';
import { Button } from '../../../components/SignUp/Button';

export function SignUpSelfieCheck() {

  const navigation = useNavigation();

  function handleContinue() {
    navigation.navigate('signupdocuments');
  }

  return (
    <Container>
      <ProgressBar progress={0.56} style={{marginTop: 74, width: "80%", left: "10%", marginBottom: 25, borderRadius: 25}} color="#16B4EE"/>
      <ContainerHeader>
      ...
      <AlignButtons>
        <TextBlule>Tirar outra foto</TextBlule>
        <Button title='Enviar'onPress={handleContinue}/>
      </AlignButtons>
    </Container>
  );
}